...
Since I'm using 12 LEDs and the fireflys require pulse width modulation (PWM) to control fade sequences, I'm going to need to use Charlieplexing in order to overcome the ratio of outputs to output sources. 
